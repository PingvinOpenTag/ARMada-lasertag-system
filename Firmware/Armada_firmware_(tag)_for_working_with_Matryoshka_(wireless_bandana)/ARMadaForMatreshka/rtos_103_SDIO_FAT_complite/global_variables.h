...
extern volatile bool bt_bandana_already_been_on;
extern volatile bool chiter_detected;
extern volatile tpicture_on_the_screen picture_on_screen;
...
extern const uint16_t chiter[0x4000];
#endif
