...
//	port.GPIO_Speed = GPIO_Speed_2MHz;
	...
	TIM_TimeBaseStructInit((TIM_TimeBaseInitTypeDef*)&timer4);
...
////	    timer3.TIM_Period = IR_START_BIT_DURATION + IR_SPACE_DURATION;
	    TIM_TimeBaseInit(TIM4, (TIM_TimeBaseInitTypeDef*)&timer4);
...
//	port.GPIO_Speed = GPIO_Speed_2MHz;
	...
	TIM_TimeBaseStructInit((TIM_TimeBaseInitTypeDef*)&timer3);
	timer3.TIM_Prescaler = /*72*/(SystemCoreClock/1000000)-1;//считаем миллисекунды
////	    timer3.TIM_Period = IR_START_BIT_DURATION + IR_SPACE_DURATION;
	    TIM_TimeBaseInit(TIM3, (TIM_TimeBaseInitTypeDef*)&timer3);
...
//	port.GPIO_Speed = GPIO_Speed_2MHz;
	...
	TIM_TimeBaseStructInit((TIM_TimeBaseInitTypeDef*)&timer5);
	timer5.TIM_Prescaler = /*72*/(SystemCoreClock/1000000)-1;//считаем миллисекунды
////	    timer3.TIM_Period = IR_START_BIT_DURATION + IR_SPACE_DURATION;
	    TIM_TimeBaseInit(TIM5, (TIM_TimeBaseInitTypeDef*)&timer5);
